...
class mouseSteelseries extends Component {
    ...
    componentDidMount() {
        fetch('https://my-json-server.typicode.com/bonapartbon/db2/mouseSteelseries')
            .then(res => res.json())
            .then(json => {
                this.setState({
                    isLoaded: true,
            ...
            return (
                <div>
                    <div className="container brand-tag border border-bottom-0 brand-div">
                        <h3 className="m-2 ">Gaming Mouse &nbsp; <i className="fas fa-caret-right"></i> &nbsp; Steelseries</h3>
                    </div>
...
export default mouseSteelseries;